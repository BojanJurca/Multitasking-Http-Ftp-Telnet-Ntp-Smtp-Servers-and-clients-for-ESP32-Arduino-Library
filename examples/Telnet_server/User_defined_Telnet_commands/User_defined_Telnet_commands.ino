...
void setup () {
  ...
  static telnetServer_t telnetServer (NULL, telnetCommandHandlerCallback);  // Cstring<255> (*getUserHomeDirectory) (const Cstring<64>& userName, const Cstring<64>& password) = NULL
