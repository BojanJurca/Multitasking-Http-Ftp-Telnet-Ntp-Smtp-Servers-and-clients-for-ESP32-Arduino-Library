...
void setup () {
  ...
  telnetServer = new (std::nothrow) telnetServer_t (NULL, NULL, 23, firewallCallback);  // Cstring<255> (*getUserHomeDirectory) (const Cstring<64>& userName, const Cstring<64>& password) = NULL
